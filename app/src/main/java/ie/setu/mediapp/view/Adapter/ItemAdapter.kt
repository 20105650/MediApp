...
class ItemAdapter(private val items: MutableList<CategoryList>, private val onEdit: (Int) -> Unit, private val onDelete: (Int) -> Unit, private val onEditAction: (Int) -> Unit, private val onDeleteAction: (Int) -> Unit) :
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.bind(item.catName,item.editSelection,item.deleteSelection,position)
