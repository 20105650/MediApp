...
import ie.setu.mediapp.view.Adapter.ItemAdapter
...
class CategoryActivity : AppCompatActivity() {
    ...
    private val viewModel: CategoryActivityVM by viewModels()
    ...
    private fun onEditItem(position: Int) {
        ...
        println("EDIT categories"+position)
        adapter.notifyDataSetChanged()
    }
    ...
    private fun onDeleteItem(position: Int) {
        ...
        println("DELETE categories"+position)
        adapter.notifyDataSetChanged()
    }
