...
import ie.setu.mediapp.databinding.ActivitySlotBinding
import ie.setu.mediapp.view.Adapter.ItemSlotAdapter

class SlotActivity : AppCompatActivity() {

    private lateinit var binding: ActivitySlotBinding
    private val viewModel: SlotActivityVM by viewModels()
...
//        setContentView(R.layout.activity_category)
        ...
        addButton.setOnClickListener {
            if (catNameET.text.isNotEmpty())
            {
                ...
                viewModel.insertSlots(slot) { isSuccess ->
                    if (isSuccess) {
                        catNameET.text = null // Clear Category field
    ...
    private fun onEditItem(position: Int) {
        ...
        println("Slot EDIT categories"+position)
        adapter.notifyDataSetChanged()
    }
    ...
    private fun onDeleteItem(position: Int) {
        ...
        println("Slot DELETE categories"+position)
        adapter.notifyDataSetChanged()
    }
